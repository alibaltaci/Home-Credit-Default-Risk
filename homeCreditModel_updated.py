...
def application_train_test(num_rows=None, nan_as_category=False):
    ...
    """
    # Read data and merge
    df = pd.read_csv('homecreditdata/application_train.csv', nrows=num_rows)
    test_df = pd.read_csv('homecreditdata/application_test.csv', nrows=num_rows)
...
def bureau_and_balance(num_rows=None, nan_as_category=True):
    ...
    """
    # Load the datasets
    bureau = pd.read_csv('homecreditdata/bureau.csv', nrows=num_rows)
    bb = pd.read_csv('homecreditdata/bureau_balance.csv', nrows=num_rows)
...
def previous_applications(num_rows=None, nan_as_category=True):
    ...
    """
    df_prev = pd.read_csv('homecreditdata/previous_application.csv', nrows=num_rows)
...
def pos_cash(num_rows=None, nan_as_category=True):
    ...
    """
    pos = pd.read_csv('homecreditdata/POS_CASH_balance.csv', nrows=num_rows)
...
def installments_payments(num_rows=None, nan_as_category=True):
    ...
    :return: dataframe
    """
    ins = pd.read_csv('homecreditdata/installments_payments.csv', nrows=num_rows)
...
def credit_card_balance(num_rows=None, nan_as_category=True):
    ...
    :return: dataframe
    """
    cc = pd.read_csv('homecreditdata/credit_card_balance.csv', nrows=num_rows)
